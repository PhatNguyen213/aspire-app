...
const AddCardButton = ({ setData }: { setData: (data: CardInfo) => void }) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col gap-6 rounded-lg shadow bg-white min-w-[40rem] p-6">
      ...
      <button
        ...
        className="px-3 py-2 flex items-center ml-auto gap-2 bg-[#325BAF] font-semibold text-[13px] text-white"
      >
        <img src={AddIcon} />
        New card
      </button>
